...
export default {
  ...
  methods: {
    ...
    genratePdf(datos) {
      ...
      var fechaHoraFormateada = dia + ' de ' + mes + ' de ' + anio + ' ' + agregarCeros(horas) + ':' + agregarCeros(minutos) + ':' + agregarCeros(segundos);
      ...
      const componenteHeader = (titulo) => {
        ...
        var impresion =
        {
          text: [{ text: 'IMPRESION: ', fontSize: 12, bold: true }, fechaHoraFormateada]
          , colSpan: 2,
        };
        return {
          headerRows: 0,
      ...
      for (var i = 0; i < datos.tvhv.length; i++) {
        var arrys = [
          ...
          },
          {
            ...
            fontSize: 8.5,
            alignment: "center",
            style: [datos.tvhv[i].Estado === "Cumple" ? 'textGreen' : 'textRed']
          },
      ...
      var docDefinition = {
        ...
        content: [
          ...
          {
            layout: "noBorders",
            table: componenteHeader("TIEMPO DE VIAJE HORA PICO (TVHP)"),margin: [0, 20, 0, 0]
          },
          ,
          {
            table: {
          ...
          {
            layout: "noBorders",
            table: componenteHeader("TIEMPO DE VIAJE HORA VALLE Y COLATERAL (TVHV)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("CUMPLIMIENTO DE INTERVALO EN HORA PICO (IHP)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("CUMPLIMIENTO DE INTERVALO EN HORA VALLE (IHV)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("Índice Velocidad planificada vs Operacional en hora pico (IVP)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("Índice Velocidad planificada vs Operacional en hora valle y colateral (IVV)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("Tiempo de permanencia del autobús en paradas en hora pico (TAP)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("Tiempo de permanencia del autobús en paradas en hora valle (TAV)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("Cumplimiento de horarios de inicio de operación (HIO)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("Cumplimiento de horarios de cierre de operación (HCO)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
          ...
          {
            layout: "noBorders",
            table: componenteHeader("Operación en ruta autorizada(desvío en ruta)(ORA)"),margin: [0, 20, 0, 0]
          },
          {
            table: {
              headerRows: 0,
