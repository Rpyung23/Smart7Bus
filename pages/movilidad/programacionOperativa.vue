...
export default {
  ...
  data() {
    return {
      ...
      oDiaTrabajo: { diasTipicos: 0, domingos: 0, sabados: 0 },
      oEstaUnidad: {
        cuenta: 0,
    ...
    genratePdf() {
      const componenteHeader = () => {
        ...
        var periodo = {
          text: [
            ...
            "Desde ",
            this.fechaDia1SalidasPanelBusqueda + " Hasta ",
      ...
      for (var i = 0; i < 1; i++) {
        var arrys = [
          ...
          {
            text: this.oDiaTrabajo.diasTipicos,
            fontSize: 9,
            alignment: "center",
            colSpan: 8,
          },
      ...
      for (var i = 0; i < 1; i++) {
        var arrys = [
          ...
          {
            text: this.oDiaTrabajo.domingos,
            fontSize: 9,
            alignment: "center",
            colSpan: 8,
          },
          ...
          },
          {
            table: {
              ...
              body: [
                ...
                ...componneteDias(),
                ...generarResultado("Maximo", this.oEstaUnidad.maximo.toFixed(2)),
                ...generarResultado("Minimo", this.oEstaUnidad.minimo.toFixed(2)),
                ...generarResultado("Rango", this.oEstaUnidad.rango.toFixed(2)),
                ...generarResultado("Cuenta", this.oEstaUnidad.cuenta.toFixed(2)),
                ...generarResultado("Mediana", this.oEstaUnidad.mediana.toFixed(2)),
                ...generarResultado("Moda", this.oEstaUnidad.moda.toFixed(2)),
                ...generarResultado("Promedio", this.oEstaUnidad.promedio.toFixed(2)),
                ...
                ...generarResultado("Rango", this.oEstaNoKm.rango.toFixed(2)),
                ...generarResultado("Cuenta", this.oEstaNoKm.cuenta.toFixed(2)),
                ...generarResultado("Mediana", this.oEstaNoKm.mediana.toFixed(2)),
                ...generarResultado("Moda", this.oEstaNoKm.moda.toFixed(2)),
                ...generarResultado("Promedio", this.oEstaNoKm.promedio.toFixed(2)),
                ...generarResultado("Desviancion Estandar", this.oEstaNoKm.desviacionEstandar.toFixed(2)),
              ],
            },
            margin: [0, 20, 0, 20],
          },
