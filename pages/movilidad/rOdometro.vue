            ...
            <div class="align-items-center py-3">
                ...
                <card class="no-border-card col" style="margin-bottom: 0.5rem"
                    ...
                    <div class="cardSelectAgrupacionRIcalidad">
                        ...
                        <el-select v-model="modelTiposEvento" collapse-tags :multiple-limit="1"
                            style="margin-right: 0.5rem" placeholder="Rutas"
                ...
                <card class="no-border-card" body-classes="card_body_0_01rem"
                    ...
                    <embed id="iframeContainerIndicadoresCalidad" :src="oBase64IndicadoresCalidad"
...
export default {
    ...
    methods: {
        ...
        async readEventosListaReporte() {
            ...
            try {
                ...
                if (datos.data.status_code == 200) {
                    ...
                    Notification.info({
                        title: "Reporte de Indicadores de Calidad Odómetro",
        ...
        genratePdf() {
            ...
            var marcaDeAgua = {
                absolutePosition: { x: 200, y: 150 }, // Posición absoluta de la marca de agua
            ...
            var docDefinition = {
                        ...
                        },
                        {
                            ...
                            table: {
                                ...
                                body: [
                                    [
                                        {
                                            text: "Reporte de Indicadores de Calidad",
                                            alignment: "center",
                                            fontSize: 16,
                                            bold: true,
                                        },
                ...
                content: [
                    ...
                    {
                        layout: "noBorders",
                        table: componenteHeader("REPORTE DE ODÓMETRO"),
                        margin: [0, 20, 0, 0],
                    },
                    {
                        table: {
           ...
           const componenteResultado = (acu, acuNo, porcentaje) => {
             ...
             return [
               [
                 ...
                 "",
                 {
                   text: "Total viajes considerados",
                   colSpan: 2,
                   alignment: "right",
                 },
                 {},
                 { text: acu + acuNo, alignment: "right", bold: true },
               ],
               [
                 "",
                 "",
                 { text: "Número que no cumplen", colSpan: 2, alignment: "right" },
                 {},
                 { text: acuNo, alignment: "right", bold: true },
               ],
               [
                 "",
                 "",
                 { text: "Número que cumplen ", colSpan: 2, alignment: "right" },
                 {},
                 { text: acu, alignment: "right", bold: true },
               ],
               [
                 "",
                 "",
           ...
           for (var i = 0; i < datos.tvhp.length; i++) {
             var arrys = [
               ...
               },
               {
                 ...
                 alignment: "center",
                 style: [
                   datos.tvhp[i].Estado === "Cumple" ? "textGreen" : "textRed",
                 ],
               },
             ];
             ...
             content: [
               ...
               //Tabla TVHV
               {
                 ...
                 table: componenteHeader(
                   "TIEMPO DE VIAJE HORA VALLE Y COLATERAL (TVHV)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla IHP
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "CUMPLIMIENTO DE INTERVALO EN HORA PICO (IHP)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla IHV
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "CUMPLIMIENTO DE INTERVALO EN HORA VALLE (IHV)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla IVP
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "Índice Velocidad planificada vs Operacional en hora pico (IVP)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla IVV
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "Índice Velocidad planificada vs Operacional en hora valle y colateral (IVV)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla TAP
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "Tiempo de permanencia del autobús en paradas en hora pico (TAP)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla TAV
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "Tiempo de permanencia del autobús en paradas en hora valle (TAV)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla HIO
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "Cumplimiento de horarios de inicio de operación (HIO)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla HCO
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "Cumplimiento de horarios de cierre de operación (HCO)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
               ...
               //Tabla ORA
               {
                 layout: "noBorders",
                 table: componenteHeader(
                   "Operación en ruta autorizada(desvío en ruta)(ORA)"
                 ),
                 margin: [0, 20, 0, 0],
               },
               {
