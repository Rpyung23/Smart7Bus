            ...
            <el-table element-loading-text="Cargando Datos..." row-key="id" v-loading="loadingPenalidadesSemanales"
              ...
              <el-table-column label="Acciones" width="140">
                <template slot-scope="scope">
                  <base-button size="sm" v-if="scope.row.atrasos > 0" title="TARJETA GRANDE(A4)"
                    @click="showModalPenalidadesSemanales(scope.row)" type="danger"><i
              ...
              <el-table-column prop="HoraSaliProgSali_mI" label="Fecha Inico" width="170">
              </el-table-column>

              <el-table-column prop="HoraSaliProgSali_mF" label="Fecha Final" width="170">
              </el-table-column>

              <el-table-column prop="totalSalidas" label="Total Salidas" width="150">
              </el-table-column>

              <el-table-column prop="DescRutaSali_m" label="Detalle Ruta" width="250">
              </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getFieldsExcel() {
      return this.$cookies.get("empresa") === "hemisfericos"
        ? this.json_fields_excelRPenalidadesSemanales_Hemisfericos
