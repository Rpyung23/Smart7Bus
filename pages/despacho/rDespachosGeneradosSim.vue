    ...
    <base-header>
      <div class="align-items-center py-3">
          ...
          <div class="cardSelectRubrosEstadosPagosVehiculoProduccionContainer">
            <div style="height: 100%; display: flex">
              <base-button
                ...
                type="primary"
                size="sm"
                @click="readDespachosGeneradosSimplificado()"
              >
        ...
        <card
          ...
          body-classes="card-bodyRPagosVehiculoReciboProduccionDGS px-0 pb-1"
          footer-classes="pb-2"
        >
          <div>
            <el-table
            ...
            >
              <el-table-column prop="HoraSaliProgSali_m" label="FECHA" width="140">
              </el-table-column>
              ...
              <el-table-column prop="FaltSali_dAtraso" label="FALTA ATRASO" width="180">
              </el-table-column>

              <el-table-column prop="MinAtraso" label="MIN ATRASO" width="180">
              </el-table-column>

              <el-table-column prop="FaltSali_dAdelanto" label="FALTA ADELANTO" width="180">
              </el-table-column>
  ...
  data() {
    return {
      ...
      json_fields_excelRDespachosGenerados: {
        ...
        "FALTA ADELANTO": "FaltSali_dAdelanto",
        "MINUTOS ADELANTO": "MinAdelanto",
        "DINERO RECAUDADO": "PenaCtrlSali_d",
      },
    };
  },
  methods: {
    ...
    async readDespachosGeneradosSimplificado() {
      this.loadingDespachosGenerados = true;
      this.RecibosWorksheetExcelRDespachosGenerados = "RDGS_W_" + Date.now();
      this.RecibosFileNameExcelRDespachosGenerados =
        "RDGS_" + Date.now() + ".xls";
      this.tableDataDespachosGenerados = [];
      try {
        var datos = await this.$axios.post(
          process.env.baseUrl + "/rDespachosGeneradosSimplificado",
          {
            token: this.token,
            unidades:
        ...
        if (datos.data.status_code == 200) {
          ...
          this.$notify({
            title: "Despachos Generados Simplificado",
...
.card-bodyRPagosVehiculoReciboProduccionDGS {
