    ...
    async readApiCumplimientoSalidas() {
      ...
      try {
        var obj = {
          ...
          unidades: this.itemUnidadCumplimientoSalidas.length <=0 ? '*' :  this.itemUnidadCumplimientoSalidas,
          rutas: this.itemRutasCumplimientoSalidas.length <=0 ? '*' :  this.itemRutasCumplimientoSalidas,
          grupos: this.itemGruposCumplimientoSalidas.length <=0 ? '*' :  this.itemGruposCumplimientoSalidas 
        };
