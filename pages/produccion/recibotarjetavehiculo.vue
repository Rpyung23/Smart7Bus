      ...
      <div class="align-items-center py-3">
        <card class="no-border-card col" style="margin-bottom: 0.5rem"
          ...
          <div class="cardSelectRubrosEstadosPagosVehiculoProduccionContainer">
            <div class="buttonCenterEndDerecha">
              ...
              <download-excel title="EXCEL" v-if="tableDataRPagosVEhiculoProduccionRecibo.length > 0
                  ? true
                  : false
                " class="btn btn-icon btn-fab btn-success btn-sm"
                :header="RecibosheaderExcelRPagosVehiculoProduccion" :data="tableDataRPagosVEhiculoProduccionRecibo"
        ...
        <card class="no-border-card col" style="margin-bottom: 0.5rem"
          ...
          <div class="cardSelectRubrosEstadosRPagosVehiculoProduccion">
            ...
            <el-select style="margin-right: 0.5rem" collapse-tags v-model="itemCobradoresProduccionRPagoVehiculorecibo"
              multiple placeholder="Operador">
        ...
        <card class="no-border-card" style="margin-bottom: 0rem"
          ...
          <div>
            <el-table v-loading="loadingRPagosVehiculoRecibo" element-loading-text="Cargando Datos..."
              :data="tableDataRPagosVEhiculoProduccionRecibo" row-key="id" height="calc(100vh - 13.1rem)"
              style="width: 100%" :default-sort="{ prop: 'estado', order: 'descending' }"
              ...
              <el-table-column prop="Codigo" label="N° Recibo" minWidth="100">
              </el-table-column>


              <el-table-column prop="Fecha" label="Fecha de Tarjeta" minWidth="140">
              </el-table-column>

              <el-table-column prop="FechaCobro" label="Fecha de Cobro" minWidth="140">
              </el-table-column>
              ...
              <el-table-column prop="Valor" sortable label="Total ($)" minWidth="100">
              </el-table-column>
      ...
      try {
        ...
        var dd = {
          ...
          content: [
            ...
            {
              text: datos[index].Descripcion, alignment: "center" ,
              alignment: "center",
              fontSize: 12,
              bold: true,
            },
