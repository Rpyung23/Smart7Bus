                ...
                <card class="no-border-card" style="margin-bottom: 0rem" body-classes="card-bodyRVelocidades px-0 pb-1"
                    ...
                    <div>
                        <el-table v-loading="loadingTableRPerjudicadoBusquedaloading"
                            ...
                            height="calc(100vh - 13rem)" width="100%">
                            ...
                            <el-table-column prop="HoraProgSali_d" label="Hora" minWidth="180">
                            </el-table-column>
                            ...
                            <el-table-column prop="AtrasoTiempo" label="A. Tiempo" minWidth="120">
                            </el-table-column>

                            <el-table-column prop="AtrasoPenalidad" label="Total" minWidth="100">
                            </el-table-column>

                            <el-table-column prop="descripcion" label="Empresa" minWidth="190">
                            </el-table-column>

                            <el-table-column prop="NombApellUsua" label="Usuario" minWidth="190">
                            </el-table-column>
        ...
        generatePdf() {
            ...
            for (var i = 0; i < this.mListaRPerjudicado.length; i++) {
                var arrys = [
                    ...
                    {
                        text: this.mListaRPerjudicado[i].DescRuta,
                        fontSize: 8.5,
                        alignment: "center",
                    },
                    {
                    ...
                    {
                        text: this.mListaRPerjudicado[i].AtrasoTiempo,
                        fontSize: 8.5,
                        alignment: "center",
                    },
                    {
