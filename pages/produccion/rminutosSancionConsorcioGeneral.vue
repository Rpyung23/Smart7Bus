    ...
    <div class="content">
        <base-header>
            <div class="align-items-center py-3">
                <card class="no-border-card col" style="margin-bottom: 0.5rem"
                    ...
                    <div class="cardTextoRPagosVehiculoProduccion">
                        ...
                        <div  style="margin: 0rem"
                            ...
                            <el-checkbox class="label-gray" style="margin-bottom : 0rem;margin-right: 0.5rem;" v-model="isFecha"
                                label="Habilitar Fecha" border size="medium"></el-checkbox>
                        </div>
                ...
                <card class="no-border-card" style="margin-bottom: 0rem; height: calc(100vh - 23vh)"
...
export default {
    ...
    methods: {
        ...
        async generatePdf() {
            ...
            console.log('Aca isfecha ',this.isFecha);
            try {
...
.label-gray {
    color: #8898aa; /* Puedes ajustar el color aquí */
}
</style>