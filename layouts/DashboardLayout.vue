    ...
    <side-bar>
      <template slot-scope="props" slot="links">
        <sidebar-item
          ...
          v-if="
            permisos != null &&
            permisos.monitoreo != null &&
            permisos.monitoreo.active != null &&
            permisos.monitoreo.active
          "
          :link="{
            name: 'Monitoreo',
        ...
        <sidebar-item
          ...
          v-if="
            permisos != null &&
            permisos.flota_vehicular != null &&
            permisos.flota_vehicular.active != null &&
            permisos.flota_vehicular.active
          "
          :link="{
        ...
        <sidebar-item
          ...
          :link="{
            ...
            path:
              ...
              permisos.despacho.panelDespacho.active != null &&
              permisos.despacho.panelDespacho.active
                ? '/despacho/panelDespacho'
                : '/despacho/panelDespachoBusqueda',
          }"
        >
        </sidebar-item>
        ...
        <sidebar-item
          ...
          v-if="
            permisos != null &&
            permisos.editor_rutas != null &&
            permisos.editor_rutas.active != null &&
            permisos.editor_rutas.active
          "
          :link="{
        ...
        <sidebar-item
          ...
          v-if="
            permisos != null &&
            permisos.Mantenimiento != null &&
            permisos.Mantenimiento.active != null &&
            permisos.Mantenimiento.active
          "
          :link="{
            name: 'Mantenimiento',
        ...
        <sidebar-item
          ...
          v-if="
            permisos != null &&
            permisos.cajaComun != null &&
            permisos.cajaComun.active != null &&
            permisos.cajaComun.active
          "
          :link="{
            name: 'Caja Común',
        ...
        <sidebar-item
          ...
          v-if="
            permisos != null &&
            permisos.liquidacion != null &&
            permisos.liquidacion.active != null &&
            permisos.liquidacion.active
          "
          :link="{
            name: 'Liquidación',
            icon: 'ni ni-money-coins text-green',
        ...
        <sidebar-item
          ...
          v-if="
            permisos != null &&
            permisos.recaudo != null &&
            permisos.recaudo.active != null &&
            permisos.recaudo.active &&
            permisos.recaudo.reportes.active != null &&
            permisos.recaudo.reportes.active
          "
          :link="{
            name: 'Recaudo',
        ...
        <sidebar-item
          ...
          v-if="
            ...
            permisos.recaudo.active != null &&
            permisos.recaudo.active &&
            permisos.recaudo.isGadAmbatoM != null &&
            permisos.recaudo.isGadAmbatoM
          "
          :link="{
            name: 'Recaudo GAD (M)',
        ...
        <sidebar-item
          ...
          v-if="
            ...
            permisos.recaudo.active != null &&
            permisos.recaudo.active &&
            permisos.recaudo.isGadAmbatoD != null &&
            permisos.recaudo.isGadAmbatoD
          "
          :link="{
            name: 'Recaudo GAD (D)',
            icon: 'ni ni-single-02 text-danger',
        ...
        >
          ...
          <sidebar-item
            :link="{
              name: 'R. Velocidades D',
              path: '/rvelocidadesDetallados',
            }"
            translate="no"
          />
          <sidebar-item :link="{ name: 'ANT', path: '/rant' }" />
          <sidebar-item
            :link="{ name: 'R. Gasolineras', path: '/rGasolinera' }"
            translate="no"
          />
          <sidebar-item
            :link="{ name: 'R. Puertas', path: '/rPuertas' }"
            translate="no"
          />
          <sidebar-item
            :link="{ name: 'R. Tipos Eventos', path: '/rTiposEventos' }"
            translate="no"
          />
          <sidebar-item
            :link="{ name: 'R. Fuera de Ruta', path: '/rFueraRuta' }"
            translate="no"
          />
        </sidebar-item>
        ...
        <sidebar-item
          ...
          v-if="
            permisos != null &&
            permisos.historial != null &&
            permisos.historial.active != null &&
            permisos.historial.active
          "
          :link="{
            name: 'Historial',
...
export default {
  ...
  mounted() {
    ...
    if (
      this.permisos != null &&
      this.permisos.produccion != null &&
      this.permisos.produccion.active != null &&
      this.permisos.produccion.active &&
      this.permisos.produccion.tablero != null &&
      this.permisos.produccion.tablero.active != null &&
      !this.permisos.produccion.tablero.active
    ) {
      this.pathProduccionTablero = "/produccion/_blank";
    }
